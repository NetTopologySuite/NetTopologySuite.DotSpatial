...
namespace NetTopologySuite.Converter.DotSpatial.Test
{
    ...
    public class ConvertAndBackTest
    {
        ...
        private static void TestLineString(ILineString ls, global::DotSpatial.Topology.ILineString lsDS)
        {
        ...
        private static void TestMultiPoint(IMultiPoint g, global::DotSpatial.Topology.IMultiPoint gDS)
        {
        ...
        private static void TestMulti<T1, T2>(T1 g, T2 gDS)
            ...
            where T2 : global::DotSpatial.Topology.IGeometryCollection
        {
            Assert.AreEqual(g.NumGeometries, gDS.NumGeometries);
        ...
        private static void TestGeometry(IGeometry g, global::DotSpatial.Topology.IGeometry g2)
        {
            if (g is IPoint)
                TestCoordinate(g.Coordinate, g2.Coordinate);
            else if (g is ILineString)
                TestLineString((ILineString)g, (global::DotSpatial.Topology.ILineString)g2);
            else if (g is IPolygon)
                TestPolygon((IPolygon)g, (global::DotSpatial.Topology.IPolygon)g2);
            else
                TestMulti((IGeometryCollection)g, (global::DotSpatial.Topology.IGeometryCollection)g2);
        }
        ...
        private static void TestPolygon(IPolygon g, global::DotSpatial.Topology.IPolygon gDS)
        {
            Assert.AreEqual(g.NumGeometries, gDS.NumGeometries);
        ...
        private static void TestCoordinate(Coordinate c1, global::DotSpatial.Topology.Coordinate c2)
        {
